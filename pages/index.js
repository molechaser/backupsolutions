...
const supportLinks = [
	{
		...
		description:
			'Online computer backups and recovery services for PC and Mac at affordable prices and 365/24/7 US based support team. If you need server backup please contact us to discuss your needs and the best solution',
		icon: PhoneIcon,
				...
				<div className="relative bg-gray-800 pb-32">
					...
					<div className="relative mx-auto max-w-7xl py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
						...
						<p className="mt-2 max-w-3xl text-xl text-gray-300">
							...
							Backups. If you have any questions regarding your account or need
							assistance, please contact them directly using the options below.
						</p>
					</div>
				</div>
